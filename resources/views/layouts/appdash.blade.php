...
<body dir="rtl">
    <div id="app">
        <header>
            <!--navbar-->
            <nav class="navbar navbar-expand-lg " style="background-color: #675D50; color: white;">
      ...
      <form class="d-flex">
        ...
        <main class="">
            ...
            <div class="row">
                  ...
                  <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 " style="background-color: #675D50; color: white">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="{{route('jam')}}" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-table  text-white p-1"></i> <span class="ms-1 d-none d-sm-inline text-white">المنتجات</span></a>
                    </li>
                   
                    <li>
                        <a href="{{route('msmp')}}" class="nav-link px-0 align-middle">
